...
public class OrderExtend implements Serializable {
    ...
    /**
     * 货主评分信息：保存 json 数组，包含评分项目 ID、分数[{"scoreItemCode":"","scoreLevel":1}]
     */
    @TableField("shipper_score_info")
    private JSONArrayWrapper shipperScoreInfo;

    /**
     * 司机评分信息：保存 json 数组，包含评分项目 ID、分数[{"scoreItemCode":"","scoreLevel":1}]
     */
     ...
     * 被评分货主id
     */
    @TableField("score_shipper_id")
    private Long scoreShipperId;


    /**
     * 被评价司机id
     */
    @TableField("score_driver_id")
    private Long scoreDriverId;
    ...
    public static final String SCORE_DRIVER_ID = "score_driver_id";

    public static final String SCORE_SHIPPER_ID = "score_shipper_id";
