...
public class PubSubReciver {
    public static void main(String[] args) throws Exception{
        ...
        // 绑定交换机和队列
        channel.queueBind(RMQConstans.ROUTING_QUEUE_NAME_1, RMQConstans.ROUTING_EXCHANGE_NAME,"");
        channel.basicConsume(RMQConstans.ROUTING_QUEUE_NAME_1, true,  new DefaultConsumer(channel){
                @Override
